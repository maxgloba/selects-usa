...
const changeState = ()=>{
	...
	if( country.value === 'US' ){
		...
		stateBox.innerHTML = '<input type="text" name="state" id="state" placeholder="State" minlength="2" required>';
	}
	changeCity();
}
...
const changeCity = ()=>{
	...
	if( country.value === 'US' ){
		...
		cityeBox.innerHTML = '<input type="text" name="city" id="city" placeholder="City" minlength="2" required>';
	}
	changeZip();
}
...
const changeZip = ()=>{
	...
	if( country.value === 'US' ){
		...
		zipeBox.innerHTML = '<input type="text" name="zip" id="zip" placeholder="ZIP" minlength="5" maxlength="5" required>';
	}
}
